-- Investigation: pattern_d01_multi_domain_exporter
-- Pattern Family: D (Cross-Domain Linkage)
-- Domain: cross-domain
...
-- False Positives: Trading companies, government procurement, conglomerates
