-- Investigation: pattern_h01_weekend_shipments
-- Pattern Family: H (Temporal Patterns)
-- Domain: all
...
-- False Positives: 24/7 operations, international time zones, data entry errors
