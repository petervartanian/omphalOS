-- Investigation: pattern_a01_payment_fragmentation_basic
-- Pattern Family: A (Payment Fragmentation)
-- Domain: all
...
-- False Positives: Letters of credit, milestone payments, currency controls
